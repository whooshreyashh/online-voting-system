      ...
      <div className="max-w-5xl w-full grid gap-10 lg:grid-cols-[1.1fr,1fr] items-center">
        ...
        <div className="hidden lg:flex flex-col gap-6 animate-fade-in-up">
          ...
          <p className="text-sm md:text-base text-slate-400 max-w-md">
            Log in to access your active elections, cast your vote, and review
            past results in a transparent and safe environment.
          </p>
        </div>
        ...
        <div className="relative animate-fade-in-up">
          {/* Animated glow */}
          <div className="pointer-events-none absolute -inset-0.5 bg-gradient-to-tr from-violet-500/40 via-transparent to-indigo-500/40 blur-3xl opacity-60 group-hover:opacity-80 transition" />
